...
export function ImageGallery({
  ...
  const [propertyTitle, setPropertyTitle] = useState(property?.property_title || property?.title || property?.name || 'My Property');
  ...
  useEffect(() => {
    setPropertyTitle(property?.property_title || property?.title || property?.name || 'My Property');
  ...
  // Apply current font accent to title/price inputs on mount
  useEffect(() => {
    const savedFont = localStorage.getItem('site-font-accent');
