  ...
  return (
    <div>
      ...
      <div className="sb-field-row">
        ...
        <p className="sb-mono">{serverIp || '00.00.00.000'}</p>
    ...
    <>
      ...
      <div className={`sidebar-panel ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="sidebar-content">
          ...
          {/* Non-admin: show simplified profile message */}
          {!isAdmin && (
            <div style={{ padding: '1rem 1.25rem' }}>
              <p style={{ color: '#374151', fontSize: '0.875rem', marginBottom: '0.5rem' }}>Your Profile</p>
              <p style={{ color: '#6b7280', fontSize: '0.8rem' }}>Signed in as <strong>{user?.full_name || user?.email}</strong></p>
              <p style={{ color: '#9ca3af', fontSize: '0.75rem', marginTop: '0.75rem' }}>Contact the property owner to manage bookings.</p>
            </div>
          )}
